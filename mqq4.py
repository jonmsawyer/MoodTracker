...
def create_window():
    ...
    layout = [
        ...
        [sg.Text("Survey:")],
        [sg.Text("1.What is the mood today?"), sg.Radio(text="Euthymic",default=False,group_id='Radio1'), sg.Radio(text="Depressed",default=False,group_id='Radio1')],
        [sg.Text("2.How many hours of sleep did you get last night?"),  sg.Spin(values=np.linspace(0,24,49),initial_value=None,size=(5,1))],
        [sg.Text("3.Did you exercise today?"),  sg.Radio('Yes','Radio2'),  sg.Radio('No','Radio2')],
        [sg.Text("4.Is the house clean?"),  sg.Radio('Yes','Radio3'),  sg.Radio('No','Radio3')],
        [sg.Text("5.Did you drink alcohol today?"),  sg.Radio('Yes','Radio4'), sg.Radio('No','Radio4')],
        [sg.Text("6.Did you have Suicidal Ideation Today"),  sg.Radio('Yes','Radio5'),  sg.Radio('No','Radio5')],
        [sg.Text('_'*80)],
...
def write_results(data):
    ...
    Manic symptoms: 11-16
    Depressive symptoms: 17-22
